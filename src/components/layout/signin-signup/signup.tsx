...
const Signup = () => {
  ...
  return (
    <div className="grid grid-cols-2   mt-10 items-center  mx-auto w-full w-[50%] bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
      <div className="px-10 space-y-2 ">
        ...
        >
          <div className="col-span-6 sm:col-span-3">
            <label
              htmlFor="FirstName"
              className="block text-sm block text-gray-700 text-sm font-medium mb-2"
            >
              Họ
            </label>
          ...
          <div className="col-span-6 sm:col-span-3">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg rounded-md focus:outline-none focus:border-indigo-500 shadow-sm"
            />
            <p className="text-red-600 text-[10px]">
      ...
      <div className="bg-[#F8F8F8] px-10 py-[50%] h-[70vh] text-center">
        <img src="/logo.png/" alt="" className="inline-block w-[100px]" />
      </div>
    </div>
  );
};
